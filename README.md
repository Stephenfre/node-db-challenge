...
<!-- SQL is a language used for managing data in a relational database. There are other languagues that work with relational databases, and there are other kinds of databases. -->
